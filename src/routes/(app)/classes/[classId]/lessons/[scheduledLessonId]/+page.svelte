...
<a
	href="/classes/{data.lesson.classId}"
...
>
	...
	>
	<span>{data.lesson.className}</span>
</a>
...
<div class="mb-3 flex items-center gap-2.5">
	...
	<span class="text-[13px] text-grey-3">Planned lesson</span>
</div>
...
<div class="flex flex-wrap items-start gap-7">
	...
	<aside class="flex min-w-[280px] flex-[1_1_300px] flex-col gap-4.5">
		...
		>
			...
			<ResourceFiles files={data.files} ownerType="scheduled" ownerId={data.lesson.id} />
		</section>
	</aside>
</div>
